...
| Identity | Separate API/admin edges and private origins; Admin WAF Prevention admits approved public egress CIDRs before inner Entra or native login; workload identities and customer-owned authorization |
